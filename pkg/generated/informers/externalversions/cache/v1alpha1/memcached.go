...
import (
	...
	apicachev1alpha1 "github.com/swghosh/k8s-exercise-operator/api/cache/v1alpha1"
	versioned "github.com/swghosh/k8s-exercise-operator/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/swghosh/k8s-exercise-operator/pkg/generated/informers/externalversions/internalinterfaces"
	cachev1alpha1 "github.com/swghosh/k8s-exercise-operator/pkg/generated/listers/cache/v1alpha1"
...
type MemcachedInformer interface {
	...
	Lister() cachev1alpha1.MemcachedLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CacheV1alpha1().Memcacheds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CacheV1alpha1().Memcacheds(namespace).Watch(context.TODO(), options)
			},
		},
		&apicachev1alpha1.Memcached{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicachev1alpha1.Memcached{}, f.defaultInformer)
}

func (f *memcachedInformer) Lister() cachev1alpha1.MemcachedLister {
	return cachev1alpha1.NewMemcachedLister(f.Informer().GetIndexer())
}
