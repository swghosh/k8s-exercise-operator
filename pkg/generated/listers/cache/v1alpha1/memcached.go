...
type MemcachedLister interface {
	...
	List(selector labels.Selector) (ret []*cachev1alpha1.Memcached, err error)
...
type memcachedLister struct {
	listers.ResourceIndexer[*cachev1alpha1.Memcached]
}

// NewMemcachedLister returns a new MemcachedLister.
func NewMemcachedLister(indexer cache.Indexer) MemcachedLister {
	return &memcachedLister{listers.New[*cachev1alpha1.Memcached](indexer, cachev1alpha1.Resource("memcached"))}
}

// Memcacheds returns an object that can list and get Memcacheds.
func (s *memcachedLister) Memcacheds(namespace string) MemcachedNamespaceLister {
	return memcachedNamespaceLister{listers.NewNamespaced[*cachev1alpha1.Memcached](s.ResourceIndexer, namespace)}
}
...
type MemcachedNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*cachev1alpha1.Memcached, error)
